...
#ifndef BITPLUS_TXGRAPH_H
#define BITPLUS_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingbitplus.org/t/introduction-to-cluster-linearization/1032
 *
