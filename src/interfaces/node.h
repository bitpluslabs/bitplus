...
#ifndef BITPLUS_INTERFACES_NODE_H
#define BITPLUS_INTERFACES_NODE_H
...
//! Top-level interface for a bitplus node (bitplusd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or bitplus.conf.
...
#endif // BITPLUS_INTERFACES_NODE_H
