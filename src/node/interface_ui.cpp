...
struct UISignals {
    btpsignals::signal<CClientUIInterface::ThreadSafeMessageBoxSig, btpsignals::optional_last_value<bool>> ThreadSafeMessageBox;
    btpsignals::signal<CClientUIInterface::ThreadSafeQuestionSig, btpsignals::optional_last_value<bool>> ThreadSafeQuestion;
    btpsignals::signal<CClientUIInterface::InitMessageSig> InitMessage;
    btpsignals::signal<CClientUIInterface::InitWalletSig> InitWallet;
    btpsignals::signal<CClientUIInterface::NotifyNumConnectionsChangedSig> NotifyNumConnectionsChanged;
    btpsignals::signal<CClientUIInterface::NotifyNetworkActiveChangedSig> NotifyNetworkActiveChanged;
    btpsignals::signal<CClientUIInterface::NotifyAlertChangedSig> NotifyAlertChanged;
    btpsignals::signal<CClientUIInterface::ShowProgressSig> ShowProgress;
    btpsignals::signal<CClientUIInterface::NotifyBlockTipSig> NotifyBlockTip;
    btpsignals::signal<CClientUIInterface::NotifyHeaderTipSig> NotifyHeaderTip;
    btpsignals::signal<CClientUIInterface::BannedListChangedSig> BannedListChanged;
};
static UISignals g_ui_signals;

#define ADD_SIGNALS_IMPL_WRAPPER(signal_name)                                                                 \
    btpsignals::connection CClientUIInterface::signal_name##_connect(std::function<signal_name##Sig> fn) \
    {                                                                                                         \
