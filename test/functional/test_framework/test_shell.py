...
class TestShell:
    """Wrapper Class for BitplusTestFramework.

    The TestShell class extends the BitplusTestFramework
    ...
    class __TestShell(BitplusTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitplusTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # BitplusTestFramework instances are supposed to be constructed with the path
