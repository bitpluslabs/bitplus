...
"""Verify that starting bitplus with -h works as expected."""

from test_framework.test_framework import BitplusTestFramework
from test_framework.util import assert_equal

class HelpTest(BitplusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitplus with -h for help text")
        ...
        self.log.info("Start bitplus with -version for version information")
        ...
        self.log.info("Start bitplusd with -fakearg to make sure it does not start")
