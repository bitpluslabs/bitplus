...
class P2PPrivateBroadcast(BitplusTestFramework):
    ...
    def run_test(self):
        ...
        # Stop the SOCKS5 proxy server to avoid it being upset by the bitplus
        ...
        self.restart_node(0, extra_args=[
            ...
            # Bitplus Core to start, hoping/assuming that the location of the Tor proxy
