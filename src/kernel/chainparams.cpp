...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].bit = 27;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].min_activation_height = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].threshold = 1815; // 90%
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].period = 2016;
        ...
        vSeeds.emplace_back("seed.bitplus.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("seed.bitplus.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btp.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bitplus.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.bitplus.wiz.biz."); // Jason Maurice
        ...
        m_assumeutxo_data = {
            {
                ...
                .blockhash = *uint256::FromHex("0000000000000000000320283a032748cef8227873ff4872689bf23f1cda83a5"),
            },
            {
                .height = 880'000,
                ...
                .blockhash = *uint256::FromHex("000000000000000000010b17283c3c400507969a9c2afd1dcf2082ec5cca2880"),
            },
            {
                .height = 910'000,
                ...
                .blockhash = *uint256::FromHex("0000000000000000000108970acb9522ffd516eae17acddcb1bd16469194a821"),
            },
            {
                .height = 935'000,
                ...
                .blockhash = *uint256::FromHex("0000000000000000000147034958af1652b2b91bba607beacc5e72a56f0fb5ee"),
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].min_activation_height = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].threshold = 1512; // 75%
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].period = 2016;
        ...
        vSeeds.emplace_back("testnet-seed.bitplus.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtp.petertodd.net.");
        vSeeds.emplace_back("seed.testnet.bitplus.sprovoost.nl.");
        ...
        m_assumeutxo_data = {
            {
                ...
                .blockhash = *uint256::FromHex("0000000000000093bcb68c03a9a168ae252572d348a2eaeba2cdf9231d73206f"),
            },
            {
                .height = 4'840'000,
                ...
                .blockhash = *uint256::FromHex("00000000000000f4971a7fb37fbdff89315b69a2e1920c467654a382f0d64786"),
            }
        };
...
public:
    CTestNet4Params() {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.bitplus.sprovoost.nl."); // Sjors Provoost
        ...
        m_assumeutxo_data = {
            {
                ...
                .blockhash = *uint256::FromHex("0000000002ebe8bcda020e0dd6ccfbdfac531d2f6a81457191b99fc2df2dbe3b"),
            },
            {
                .height = 120'000,
                ...
                .blockhash = *uint256::FromHex("000000000bd2317e51b3c5794981c35ba894ce27d3e772d5c39ecd9cbce01dc8"),
            }
        };
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.bitplus.sprovoost.nl.");
        ...
        m_assumeutxo_data = {
            {
                ...
                .blockhash = *uint256::FromHex("0000003ca3c99aff040f2563c2ad8f8ec88bd0fd6b8f0895cfaf1ef90353a62c"),
            },
            {
                .height = 290'000,
                ...
                .blockhash = *uint256::FromHex("0000000577f2741bb30cd9d39d6d71b023afbeb9764f6260786a97969d5c9ac0"),
            }
        };
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].min_activation_height = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].threshold = 108; // 75%
        consensus.vDeployments[Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS].period = 144;
        ...
        m_assumeutxo_data = {
            {   // For use by unit tests
                ...
                .blockhash = *uint256::FromHex("6affe030b7965ab538f820a56ef56c8149b7dc1d1c144af57113be080db7c397"),
            },
            {
                ...
                .blockhash = *uint256::FromHex("385901ccbd69dff6bbd00065d01fb8a9e464dede7cfe0372443884f9b1dcf6b9"),
            },
            {
                // For use by test/functional/feature_assumeutxo.py and test/functional/tool_bitplus_chainstate.py
                .height = 299,
                .hash_serialized = AssumeutxoHash{uint256{"d2b051ff5e8eef46520350776f4100dd710a63447a8e01d917e92e79751a63e2"}},
                .m_chain_tx_count = 334,
                .blockhash = *uint256::FromHex("7cc695046fec709f8c9394b6f928f81e81fd3ac20977bb68760fa1faa7916ea2"),
            },
        };
