...
static RPCMethod waitfornewblock()
{
    return RPCMethod{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (bitplus-cli -rpcclienttimeout=0)",
                {
...
UniValue DeploymentInfo(const CBlockIndex* blockindex, const ChainstateManager& chainman)
{
    ...
    SoftForkDescPushBack(blockindex, softforks, chainman, Consensus::DEPLOYMENT_INSTITUTIONAL_CONTRACTS);
    return softforks;
}
} // anon namespace
...
static RPCMethod scanblocks()
{
    return RPCMethod{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (bitplus-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCMethod getdescriptoractivity()
{
    return RPCMethod{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (bitplus-cli -rpcclienttimeout=0)",
        {
...
static RPCMethod dumptxoutset()
{
    return RPCMethod{
        ...
        "For deep rollbacks, make sure to use no RPC timeout (bitplus-cli -rpcclienttimeout=0) as it may take several minutes.",
        {
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/bitplus/bitplus/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/bitplus/bitplus/issues/25675
...
static RPCMethod loadtxoutset()
{
    return RPCMethod{
        ...
        "The result is a usable bitplusd instance that is current with the network tip in a "
        ...
        "document (<https://github.com/bitplus/bitplus/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
