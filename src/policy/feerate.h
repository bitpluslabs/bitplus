...
#ifndef BITPLUS_POLICY_FEERATE_H
#define BITPLUS_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "BTP"; // One formatted unit
const std::string CURRENCY_ATOM = "sat"; // One indivisible minimum value unit

enum class FeeRateFormat {
    BTP_KVB, //!< Use BTP/kvB fee rate unit
...
public:
    ...
    std::string ToString(FeeRateFormat fee_rate_format = FeeRateFormat::BTP_KVB) const;
...
#endif // BITPLUS_POLICY_FEERATE_H
