...
RPCMethod getnewaddress()
{
    return RPCMethod{
        "getnewaddress",
        "Returns a new Bitplus address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new bitplus address"
                },
                RPCExamples{
...
RPCMethod getrawchangeaddress()
{
    return RPCMethod{
        "getrawchangeaddress",
        "Returns a new Bitplus address, for receiving change.\n"
...
RPCMethod setlabel()
{
    return RPCMethod{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitplus address to be associated with a label."},
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Bitplus address");
    }
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The bitplus address"},
...
RPCMethod getaddressinfo()
{
    return RPCMethod{
        "getaddressinfo",
        "Return information about the given bitplus address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitplus address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The bitplus address validated."},
...
RPCMethod walletdisplayaddress()
{
    return RPCMethod{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "bitplus address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
