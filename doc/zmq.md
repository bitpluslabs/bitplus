...
The Bitplus Core daemon can be configured to act as a trusted "border
router", implementing the bitplus wire protocol and relay, making
...
The ZeroMQ feature in Bitplus Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ bitplusd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/bitplusd.tx.raw \
...
From the perspective of bitplusd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into bitplusd directly. Furthermore, no information is
...
using. Bitplusd appends an up-counting sequence number to each
