...
static RPCMethod addnode()
{
    return RPCMethod{
        ...
        "Attempts to add or remove a node from the addnode list.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:9457\" \"onetry\" true")
            + HelpExampleRpc("addnode", "\"192.168.0.6:9457\", \"onetry\" true")
                },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCMethod addconnection()
{
    return RPCMethod{
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.0.6:9457\" \"outbound-full-relay\" true")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:9457\" \"outbound-full-relay\" true")
        },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCMethod disconnectnode()
{
    return RPCMethod{
        ...
        "Immediately disconnects from the specified peer node.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:9457\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:9457\"")
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The bitplus server IP and port we're connected to"},
