Bitplus Core version 0.16.1 is now available from:

  <https://bitpluscore.org/bin/bitplus-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitplusd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitplusd processes are cleaned up when tests end (sdaftuar)
