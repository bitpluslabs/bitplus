...
```sh
cmake --build build --target bitplusd bitplus-cli
cmake --build build --target bitplus-qt
cmake --build build --target bench_bitplus
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitplus/bitplus.git
```
...
> e.g. github.com/bitplus/bitplus.git or for the GUI github.com/bitplus-core/gui
