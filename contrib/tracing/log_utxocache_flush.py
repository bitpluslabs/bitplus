...
"""Example logging Bitplus Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of bitplusd>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[bitplusd_with_usdts])
