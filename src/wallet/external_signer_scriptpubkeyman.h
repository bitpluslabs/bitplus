...
#ifndef BITPLUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITPLUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITPLUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
