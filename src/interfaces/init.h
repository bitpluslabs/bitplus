...
#ifndef BITPLUS_INTERFACES_INIT_H
#define BITPLUS_INTERFACES_INIT_H
...
//! (bitplus-gui, bitplus-node, bitplus-wallet, bitplusd, bitplus-qt) and each
...
#endif // BITPLUS_INTERFACES_INIT_H
