...
{
    // Regression test for bitplus/bitplus#34711, bitplus/bitplus#34756 where a
...
{
    // Regression test for bitplus/bitplus#34777 heap-use-after-free where
...
{
    // Regression test for bitplus/bitplus#34782 stack-use-after-return where
