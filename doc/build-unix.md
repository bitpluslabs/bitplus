UNIX BUILD NOTES
====================
Some notes on how to build Bitplus Core in Unix.
...
memory available when compiling Bitplus Core. On systems with less, gcc can be
...
To build Bitplus Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Bitplus Core can
