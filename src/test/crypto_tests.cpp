...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Bitplus relies on 80 byte header hashes, we want to have an example for that.",
               "23ae8f0cb961fef41c3a0b3b9e6c79fc3ea91c5fcf3bc7302d580a735cb3437a");
