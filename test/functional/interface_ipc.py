...
class IPCInterfaceTest(BitplusTestFramework):
    ...
    def run_unclean_disconnect_test(self):
        ...
        reported https://github.com/bitplus/bitplus/issues/34250, but now just
    ...
    def run_thread_busy_test(self):
        ...
        https://github.com/bitplus/bitplus/issues/33923."""
        node = self.nodes[0]
