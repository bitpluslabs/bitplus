...
function(extract_strings output)
  ...
  file(STRINGS "bitplusstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *bitplus_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"bitplus-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/bitplusstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/bitplusstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/bitplus_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/bitplus_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/bitplus_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/bitplus_en.xlf" bitplus_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" bitplus_en "${bitplus_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" bitplus_en "${bitplus_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/bitplus_en.xlf" "${bitplus_en}")
