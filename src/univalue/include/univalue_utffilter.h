...
#ifndef BITPLUS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BITPLUS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BITPLUS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
