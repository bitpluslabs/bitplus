...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitplusTestFramework
    pass


class ExampleTest(BitplusTestFramework):
    # Each functional test is a subclass of the BitplusTestFramework class.
    ...
    def custom_method(self):
        ...
        BitplusTestFramework class so other tests can use it."""
