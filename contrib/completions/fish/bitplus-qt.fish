...
complete --command bitplus-qt --no-files

# Extract options
function __fish_bitplusqt_get_options
...
complete \
    --command bitplus-qt \
    --arguments "(__fish_bitplusqt_get_options --nofiles)"
