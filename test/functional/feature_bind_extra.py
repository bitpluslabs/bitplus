...
"""
Test starting bitplusd with -bind and/or -bind=...=onion, confirm that
...
class BindExtraTest(BitplusTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that bitplusd has bound on "::1" (for RPC) and "::" (for P2P).
