...
BOOST_AUTO_TEST_CASE(test_LocaleIndependentAtoi)
{
    ...
    // Ensure legacy compatibility with previous versions of Bitplus Core's atoi64
    for (const auto& pair : atoi64_test_pairs) {
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("bitplus"), "Bitplus");
...
BOOST_AUTO_TEST_CASE(test_LogEscapeMessage)
{
    ...
    BOOST_CHECK_EQUAL(BCLog::LogEscapeMessage("Valid log messageè²“"), "Valid log messageè²“");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    ...
    const std::string expected_signature =
        "IAyCFd6ilmX8dkDxMHmw2ZRUxsflXe9J284nV1bLnMXjRxUj/QxS2ZWCq0CQHjmd3wANpTqn1IZy4Kw4q5JFGXY=";
...
BOOST_AUTO_TEST_CASE(util_WriteBinaryFile)
{
    ...
    std::string expected_text = "bitplus";
