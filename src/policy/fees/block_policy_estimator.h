...
#ifndef BITPLUS_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define BITPLUS_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // BITPLUS_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
