...
#ifndef BITPLUS_QT_BITPLUSGUI_H
#define BITPLUS_QT_BITPLUSGUI_H
...
/**
  Bitplus GUI main class. This class represents the main window of the Bitplus UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitplusGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitplusGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitplusGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitplus wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BitplusUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitplus Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BitplusUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BITPLUS_QT_BITPLUSGUI_H
