...
#ifndef BITPLUS_NOUI_H
#define BITPLUS_NOUI_H
...
/** Connect all bitplusd signal handlers */
void noui_connect();

/** Redirect all bitplusd signal handlers to LogInfo. Used to check or suppress output during test runs that produce expected errors */
void noui_test_redirect();

/** Reconnects the regular Non-GUI handlers after having used noui_test_redirect */
void noui_reconnect();

#endif // BITPLUS_NOUI_H
