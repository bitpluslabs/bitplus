...
#ifndef BITPLUS_TEST_SCRIPTNUM10_H
#define BITPLUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitplus Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITPLUS_TEST_SCRIPTNUM10_H
