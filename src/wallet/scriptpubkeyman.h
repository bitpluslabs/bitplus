...
#ifndef BITPLUS_WALLET_SCRIPTPUBKEYMAN_H
#define BITPLUS_WALLET_SCRIPTPUBKEYMAN_H
...
public:
    ...
    /** Birth time changed */
    btpsignals::signal<void (const ScriptPubKeyMan* spkm, int64_t new_birth_time)> NotifyFirstKeyTimeChanged;
};
...
#endif // BITPLUS_WALLET_SCRIPTPUBKEYMAN_H
