...
#ifndef BITPLUS_SCRIPT_SCRIPT_H
#define BITPLUS_SCRIPT_SCRIPT_H
...
enum opcodetype
{
    ...
    // Opcode added by Bitplus institutional contracts (Tapscript only)
    OP_CHECKOUTPUTVERIFY = 0xbc,
...
public:
    ...
    /**
     * Pre-version-0.6, Bitplus always counted CHECKMULTISIGs
