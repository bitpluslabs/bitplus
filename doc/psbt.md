# PSBT Howto for Bitplus Core

Since Bitplus Core 0.17, an RPC interface exists for Partially Signed Bitplus
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/bitplus/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Bitplus transactions that are not fully signed
...
#### Multisig with multiple Bitplus Core instances
