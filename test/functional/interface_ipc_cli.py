...
class TestBitplusIpcCli(BitplusTestFramework):
    ...
    def test_cli(self, args, error=None):
        ...
        args = [self.binary_paths.bitpluscli, f"-datadir={self.nodes[0].datadir_path}", "-rpcpassword=wrong"] + args + ["echo", "foo"]
...
if __name__ == '__main__':
    TestBitplusIpcCli(__file__).main()
