...
#ifndef BITPLUS_CONSENSUS_PARAMS_H
#define BITPLUS_CONSENSUS_PARAMS_H
...
enum DeploymentPos : uint16_t {
    ...
    DEPLOYMENT_INSTITUTIONAL_CONTRACTS,
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Bitplus Script solution
...
#endif // BITPLUS_CONSENSUS_PARAMS_H
