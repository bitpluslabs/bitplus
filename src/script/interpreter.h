...
#ifndef BITPLUS_SCRIPT_INTERPRETER_H
#define BITPLUS_SCRIPT_INTERPRETER_H
...
enum class script_verify_flag_name : uint8_t {
    ...
    // Bitplus institutional contract validation.
    SCRIPT_VERIFY_INSTITUTIONAL_CONTRACTS,
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/bitplus/bips/blob/master/bip-0341.mediawiki#cite_note-16.
...
public:
    ...
    virtual bool CheckOutput(const CScriptNum& nOutput, const CScriptNum& nAmount, std::span<const unsigned char> scriptPubKeyHash) const
    {
        return false;
    }
...
public:
    ...
    bool CheckOutput(const CScriptNum& nOutput, const CScriptNum& nAmount, std::span<const unsigned char> scriptPubKeyHash) const override;
};
...
public:
    ...
    bool CheckOutput(const CScriptNum& nOutput, const CScriptNum& nAmount, std::span<const unsigned char> scriptPubKeyHash) const override
    {
        return m_checker.CheckOutput(nOutput, nAmount, scriptPubKeyHash);
    }
};
...
#endif // BITPLUS_SCRIPT_INTERPRETER_H
