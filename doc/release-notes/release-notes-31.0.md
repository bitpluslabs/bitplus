...
Bitplus Core version 31.0 is now available from:

  <https://bitpluscore.org/bin/bitplus-core-31.0/>
...
(on Windows) or just copy over `/Applications/Bitplus-Qt` (on macOS) or
`bitplusd`/`bitplus-qt` (on Linux).

Upgrading directly from a version of Bitplus Core that has reached its EOL is
possible, but it might take some time if the data directory needs to be
migrated. Old wallet versions of Bitplus Core are generally supported.

Compatibility
==============

Bitplus Core is supported and tested on the following operating systems or
newer: Linux Kernel 3.17, macOS 14, and Windows 10 (version 1903). Bitplus Core
should also work on most other Unix-like systems but is not as frequently tested
on them. It is not recommended to use Bitplus Core on unsupported systems.
...
`-dbcache=450`. See
[reduce-memory.md](https://github.com/bitplus/bitplus/blob/master/doc/reduce-memory.md)
...
than the original. See [delvingbitplus.org
post](https://delvingbitplus.org/t/an-overview-of-the-cluster-mempool-proposal/393#rbf-can-now-be-made-incentive-compatible-for-miners-11)
...
[doc/policy/mempool-terminology.md](https://github.com/bitplus/bitplus/blob/master/doc/policy/mempool-terminology.md)
and
[doc/policy/mempool-replacements.md](https://github.com/bitplus/bitplus/blob/master/doc/policy/mempool-replacements.md).
...
created on 2026-03-05](https://github.com/bitplus/bitplus/pull/34696). Despite
...
being deprecated in Bitplus Core 30.0. They used to allow the user to set a
...
The Bitplus Core fee estimator minimum fee rate bucket was updated from **1
