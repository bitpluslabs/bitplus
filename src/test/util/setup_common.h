...
#ifndef BITPLUS_TEST_UTIL_SETUP_COMMON_H
#define BITPLUS_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/bitplus/bitplus/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // BITPLUS_TEST_UTIL_SETUP_COMMON_H
