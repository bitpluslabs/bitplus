...
#ifndef BITPLUS_WALLET_WALLET_H
#define BITPLUS_WALLET_WALLET_H
...
public:
     ...
     * bitplus-wallet tool code or by wallet migration code. If this is called
    ...
    btpsignals::signal<void ()> NotifyUnload;

    /**
     * Address book entry changed.
     * @note called without lock cs_wallet held.
     */
    btpsignals::signal<void(const CTxDestination& address,
     ...
     */
    btpsignals::signal<void(const Txid& hashTx, ChangeType status)> NotifyTransactionChanged;

    /** Show progress e.g. for rescan */
    btpsignals::signal<void (const std::string &title, int nProgress)> ShowProgress;

    /** Keypool has new keys */
    btpsignals::signal<void ()> NotifyCanGetAddressesChanged;

    /**
     * Wallet status (encrypted, locked) changed.
     * Note: Called without locks held.
     */
    btpsignals::signal<void (CWallet* wallet)> NotifyStatusChanged;
