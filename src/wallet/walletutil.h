...
#ifndef BITPLUS_WALLET_WALLETUTIL_H
#define BITPLUS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitplus from opening the wallet, thinking it was newly created, and
...
#endif // BITPLUS_WALLET_WALLETUTIL_H
