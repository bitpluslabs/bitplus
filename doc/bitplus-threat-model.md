...
- All commitment formats use fixed magic bytes, explicit version bytes, and stable
  endian rules.
- Readiness checks require complete prevout review and include chain snapshot and
  confirmation evidence.
- Reconciliation cursors bind to cursor version, asset id, filters, height, and
  best block.
