...
#ifndef BITPLUS_NODE_INTERFACE_UI_H
#define BITPLUS_NODE_INTERFACE_UI_H
...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...)                                  \
    ...
    btpsignals::connection signal_name##_connect(std::function<signal_name##Sig> fn)
...
#endif // BITPLUS_NODE_INTERFACE_UI_H
