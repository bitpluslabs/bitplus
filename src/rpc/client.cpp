...
//! Specify whether parameter should be parsed by bitplus-cli as a JSON value,
 ...
 *
 * JSON parameters need to be listed here to make bitplus-cli parse command line
 * arguments as JSON, instead of passing them as raw strings. `JSON` and
 * `JSON_OR_STRING` formats both make `bitplus-cli` attempt to parse the
 ...
 * `bitplus-cli getblockstats <hash>` without needing to quote the hash string
 * as JSON (`'"<hash>"'`).
 *
 ...
 * to make bitplus-cli treat them as positional parameters when `-named` is used.
 * This prevents `bitplus-cli` from splitting strings like "my=wallet" into a named
 ...
 * other string parameters for that method need to be listed as well so bitplus-cli
...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "decodebitplusscript", 1, "amount" },
    { "decodebitplusscript", 2, "output_index" },
    { "analyzebitplustransaction", 1, "spent_outputs" },
    { "analyzebitplustransaction", 2, "lookup_spent_outputs" },
    { "createbitplusscripttransaction", 0, "inputs" },
    { "createbitplusscripttransaction", 1, "outputs" },
    { "createbitplusscripttransaction", 2, "locktime" },
    { "createbitplusscripttransaction", 3, "replaceable" },
    { "createbitplusscripttransaction", 4, "version" },
    { "createbitpluspsbt", 0, "inputs" },
    { "createbitpluspsbt", 1, "outputs" },
    { "createbitpluspsbt", 2, "locktime" },
    { "createbitpluspsbt", 3, "replaceable" },
    { "createbitpluspsbt", 4, "version" },
    { "preparebitpluspsbt", 0, "psbt", ParamFormat::STRING },
    { "preparebitpluspsbt", 1, "descriptors" },
    { "checkbitplussettlement", 0, "transaction", ParamFormat::STRING },
    { "checkbitplussettlement", 1, "format", ParamFormat::STRING },
    { "checkbitplussettlement", 2, "check_mempool" },
    { "checkbitplussettlement", 3, "maxfeerate" },
    { "checkbitplussettlement", 4, "min_input_confirmations" },
    { "scanbitplusassetutxos", 0, "asset_id", ParamFormat::STRING },
    { "scanbitplusassetutxos", 1, "max_results" },
    { "scanbitplusassetutxos", 2, "filters" },
    { "scanbitplusassetutxos", 3, "cursor" },
    { "getbitplusassetstats", 0, "asset_id", ParamFormat::STRING },
    { "getbitplusassetstats", 1, "filters" },
    { "getbitplusmemberassetstats", 0, "member_hash", ParamFormat::STRING },
    { "getbitplusmemberassetstats", 1, "filters" },
    { "createbitplusassetid", 2, "vout" },
    { "createbitplusassetwhitelist", 3, "flags" },
    { "createbitplusassetwhitelistroot", 0, "members" },
    { "createbitplusassetwhitelistroot", 1, "proof_index" },
    { "createbitplusassetissuance", 1, "vout" },
    { "createbitplusassetissuance", 2, "amount" },
    { "createbitplusassetissuance", 9, "flags" },
    { "createbitplusasset", 2, "amount" },
    { "createbitplusassettransfer", 1, "amount" },
    { "createbitplusassettransfer", 4, "asset_output_index" },
    { "createbitplusassettransfer", 5, "proof_index" },
    { "createbitplusassettransfer", 6, "merkle_path" },
    { "createbitplusassetburn", 1, "amount" },
    { "createbitplusassetwhitelistproof", 0, "asset_output_index" },
    { "createbitplusassetwhitelistproof", 2, "proof_index" },
    { "createbitplusassetwhitelistproof", 3, "merkle_path" },
    { "createbitplusdvp", 2, "asset_amount" },
    { "createbitplusdvp", 5, "asset_output_index" },
    { "createbitplusdvp", 6, "proof_index" },
    { "createbitplusdvp", 7, "merkle_path" },
    { "createbitplusdvp", 10, "payment_amount" },
    { "createbitplusdvp", 11, "payment_output_index" },
    { "createbitpluspvp", 2, "first_asset_amount" },
    { "createbitpluspvp", 5, "first_asset_output_index" },
    { "createbitpluspvp", 6, "first_proof_index" },
    { "createbitpluspvp", 7, "first_merkle_path" },
    { "createbitpluspvp", 10, "second_asset_amount" },
    { "createbitpluspvp", 13, "second_asset_output_index" },
    { "createbitpluspvp", 14, "second_proof_index" },
    { "createbitpluspvp", 15, "second_merkle_path" },
    { "createbitplusvault", 2, "recovery_amount" },
    { "createbitplusvault", 3, "recovery_output_index" },
    { "createbitplusvault", 4, "relative_delay" },
    { "createbitplusvault", 6, "destination_amount" },
    { "createbitplusvault", 7, "destination_output_index" },
    { "createbitplushtlc", 3, "claim_amount" },
    { "createbitplushtlc", 4, "claim_output_index" },
    { "createbitplushtlc", 5, "absolute_expiry" },
    { "createbitplushtlc", 7, "refund_amount" },
    { "createbitplushtlc", 8, "refund_output_index" },
    { "createbitpluscollateral", 2, "release_amount" },
    { "createbitpluscollateral", 3, "release_output_index" },
    { "createbitpluscollateral", 4, "relative_delay" },
    { "createbitpluscollateral", 6, "return_amount" },
    { "createbitpluscollateral", 7, "return_output_index" },
    { "createbitplusrefundpaths", 1, "absolute_expiry" },
    { "createbitplusrefundpaths", 3, "absolute_refund_amount" },
    { "createbitplusrefundpaths", 4, "absolute_refund_output_index" },
    { "createbitplusrefundpaths", 5, "relative_delay" },
    { "createbitplusrefundpaths", 7, "relative_refund_amount" },
    { "createbitplusrefundpaths", 8, "relative_refund_output_index" },
    { "createbitpluscovleaf", 1, "amount" },
    { "createbitpluscovleaf", 2, "output_index" },
    { "createbitplusvaultrecoveryleaf", 2, "amount" },
    { "createbitplusvaultrecoveryleaf", 3, "output_index" },
    { "createbitplusvaultdelayedleaf", 1, "relative_delay" },
    { "createbitplusvaultdelayedleaf", 3, "amount" },
    { "createbitplusvaultdelayedleaf", 4, "output_index" },
    { "createbitplushtlcclaimleaf", 3, "amount" },
    { "createbitplushtlcclaimleaf", 4, "output_index" },
    { "createbitplushtlcrefundleaf", 1, "absolute_expiry" },
    { "createbitplushtlcrefundleaf", 3, "amount" },
    { "createbitplushtlcrefundleaf", 4, "output_index" },
    { "createbitplusdvpleaf", 2, "asset_amount" },
    { "createbitplusdvpleaf", 5, "asset_output_index" },
    { "createbitplusdvpleaf", 7, "payment_amount" },
    { "createbitplusdvpleaf", 8, "payment_output_index" },
    { "createbitpluspvpleaf", 2, "first_asset_amount" },
    { "createbitpluspvpleaf", 5, "first_asset_output_index" },
    { "createbitpluspvpleaf", 7, "second_asset_amount" },
    { "createbitpluspvpleaf", 10, "second_asset_output_index" },
    { "createbitpluscollateralreleaseleaf", 2, "amount" },
    { "createbitpluscollateralreleaseleaf", 3, "output_index" },
    { "createbitpluscollateralreturnleaf", 1, "relative_delay" },
    { "createbitpluscollateralreturnleaf", 3, "amount" },
    { "createbitpluscollateralreturnleaf", 4, "output_index" },
    { "createbitplusrefundabsoluteleaf", 1, "absolute_expiry" },
    { "createbitplusrefundabsoluteleaf", 3, "amount" },
    { "createbitplusrefundabsoluteleaf", 4, "output_index" },
    { "createbitplusrefundrelativeleaf", 1, "relative_delay" },
    { "createbitplusrefundrelativeleaf", 3, "amount" },
    { "createbitplusrefundrelativeleaf", 4, "output_index" },
    ...
    { "analyzebitpluspsbt", 0, "psbt", ParamFormat::STRING},
 ...
 *
 * For example, the command `bitplus-cli -named createwallet "my=wallet"`,
