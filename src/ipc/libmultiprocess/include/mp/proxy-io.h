...
extern thread_local ThreadContext g_thread_context; // NOLINT(bitplus-nontrivial-threadlocal)
// Silence nonstandard bitplus tidy error "Variable with non-trivial destructor
