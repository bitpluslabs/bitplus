...
#ifndef BITPLUS_TXMEMPOOL_H
#define BITPLUS_TXMEMPOOL_H
 ...
 * Bitplus-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Bitplus-specific parts of mempool
