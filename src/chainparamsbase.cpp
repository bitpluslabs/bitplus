...
/**
 * Port numbers for incoming Tor connections (9458, 19458, 29458, 39458, 49458) have
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 9456);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 19456);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 29456);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 39456);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 49456);
    }
    assert(false);
}
