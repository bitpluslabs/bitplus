Bitplus Core version 0.10.4 is now available from:

  <https://bitplus.org/bin/bitplus-core-0.10.4/>
...
- #6953 `43c2789` Split bitplus-tx into its own package
- #6953 `dfe0d4d` Include bitplus-tx binary on Debian/Ubuntu
