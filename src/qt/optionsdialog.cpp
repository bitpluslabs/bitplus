      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitplusAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitplusAtStartup);
    ...
    ui->bitplusAtStartup->setToolTip(ui->bitplusAtStartup->toolTip().arg(CLIENT_NAME));
    ui->bitplusAtStartup->setText(ui->bitplusAtStartup->text().arg(CLIENT_NAME));

    ui->openBitplusConfButton->setToolTip(ui->openBitplusConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new BitplusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitplusAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBTPontrols);
...
void OptionsDialog::on_openBitplusConfButton_clicked()
{
