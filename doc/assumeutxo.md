...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitplusd
instance.
...
```
$ bitplus-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitplus-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
