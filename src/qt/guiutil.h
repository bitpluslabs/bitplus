...
#ifndef BITPLUS_QT_GUIUTIL_H
#define BITPLUS_QT_GUIUTIL_H
...
/** Utility functions used by the Bitplus Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitplus:" URI into recipient object, return true on successful parsing
