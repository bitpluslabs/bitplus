...
This file is modified from python-bitpluslib.
"""
...
def bn2vch(v):
    """Convert number to bitplus-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in the original codebase"""
    r = b''
