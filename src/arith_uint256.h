...
#ifndef BITPLUS_ARITH_UINT256_H
#define BITPLUS_ARITH_UINT256_H
...
public:
     ...
     *
     * Bitplus only uses this "compact" format for encoding difficulty
