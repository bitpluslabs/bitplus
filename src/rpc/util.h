...
#ifndef BITPLUS_RPC_UTIL_H
#define BITPLUS_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting BTP/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1BTP/kvB.
 */
