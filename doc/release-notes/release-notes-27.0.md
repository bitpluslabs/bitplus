Bitplus Core version 27.0 is now available from:

  <https://bitpluscore.org/bin/bitplus-core-27.0/>
...
- libbitplusconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libbitpluskernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Bitplus Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Bitplus Core would
