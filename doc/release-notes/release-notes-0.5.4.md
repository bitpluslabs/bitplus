Bitplus version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitplus/files/Bitplus/bitplus-0.5.4/
...
http://gitorious.org/bitplus/bitplusd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitplus-Qt notifications under Growl 1.3.
Increase required age of Bitplus-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitplus properly when installing Bitplus-Qt over it. (Windows)
