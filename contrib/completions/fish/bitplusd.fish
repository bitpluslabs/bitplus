...
complete --command bitplusd --no-files

# Extract options
function __fish_bitplusd_get_options
...
complete \
    --command bitplusd \
    --arguments "(__fish_bitplusd_get_options --nofiles)"
