...
This document provides guidelines for internationalization of the Bitplus Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `bitplus_en.ts` remains unchanged.
