...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitplusd node closes feeler connections as soon as a version
...
class P2PAddConnections(BitplusTestFramework):
    ...
    def run_test(self):
        ...
        # bitplusd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitplusd sends its own version prior to processing
