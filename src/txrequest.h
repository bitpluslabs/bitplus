...
#ifndef BITPLUS_TXREQUEST_H
#define BITPLUS_TXREQUEST_H
 ...
 *   specific transaction. See https://bitpluscore.org/en/2024/07/03/disclose_already_asked_for.
 */
