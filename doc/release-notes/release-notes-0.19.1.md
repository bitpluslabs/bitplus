...
Bitplus Core version 0.19.1 is now available from:

  <https://bitpluscore.org/bin/bitplus-core-0.19.1/>
...
From Bitplus Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitplus Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitplus Core does not yet change appearance when
...
- #17488 fix "bitplusd already running" warnings on macOS (fanquake)
