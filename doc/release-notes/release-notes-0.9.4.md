Bitplus Core version 0.9.4 is now available from:

  https://bitplus.org/bin/0.9.4/
...
this update is incompatible with the Bitplus system and could lead to consensus
forks.

Bitplus Core released binaries from https://bitplus.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitplus/+archive/ubuntu/bitplus
- A third-party or self-compiled Bitplus Core

upgrade to Bitplus Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
