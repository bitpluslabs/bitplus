...
#ifndef BITPLUS_CHAINPARAMSBASE_H
#define BITPLUS_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between bitplus-cli and bitplusd)
 * of a given instance of the Bitplus system.
 */
...
#endif // BITPLUS_CHAINPARAMSBASE_H
