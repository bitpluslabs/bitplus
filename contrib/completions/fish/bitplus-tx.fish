...
# Extract options
function __fish_bitplus_tx_get_options
...
# Extract commands
function __fish_bitplus_tx_get_commands
...
complete \
    --command bitplus-tx \
    --condition "not __fish_bitplus_seen_cmd (__fish_bitplus_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitplus_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitplus-tx \
    --arguments "(__fish_bitplus_tx_get_commands)" \
    --no-files
