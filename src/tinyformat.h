...
#include <algorithm>
#include <attributes.h> // Added for Bitplus Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Bitplus Core
#include <util/string.h> // Added for Bitplus Core
...
// Added for Bitplus Core. Similar to std::runtime_format from C++26.
...
// Added for Bitplus Core. Wrapper for checking format strings at compile time.
