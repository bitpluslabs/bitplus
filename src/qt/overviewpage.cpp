...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = BitplusUnits::formatWithUnit(unit, amount, true, BitplusUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    BitplusUnit unit{BitplusUnit::BTP};
...
{
    BitplusUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(BitplusUnits::formatWithPrivacy(unit, balances.balance, BitplusUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(BitplusUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, BitplusUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(BitplusUnits::formatWithPrivacy(unit, balances.immature_balance, BitplusUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(BitplusUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, BitplusUnits::SeparatorStyle::ALWAYS, m_privacy));
