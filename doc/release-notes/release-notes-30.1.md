...
Bitplus Core version v30.1 is now available from:

  <https://bitpluscore.org/bin/bitplus-core-30.1/>
...
- #33229 multiprocess: Don't require bitplus -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.bitplus.dashjr-list-of-p2p-nodes.us
