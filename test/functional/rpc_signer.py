...
Verify that a bitplusd node can use an external signer command.
...
class RPCSignerTest(BitplusTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitplusd with -signer=<cmd>',
