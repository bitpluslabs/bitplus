...
Bitplus Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Bitplus Core

**When configuring Bitplus Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Bitplus Core:
...
variables will be set when generating the Bitplus Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
