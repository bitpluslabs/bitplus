...
By default, bitplusd will dump mempool on shutdown and
...
class MempoolPersistTest(BitplusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitplusd from writing mempool.dat to disk. Verify that `savemempool` fails")
