...
{
    // Test regression https://github.com/bitplus/bitplus/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitplus-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitplus-core/gui/pull/568.
    // With fListen=false in ~/.config/Bitplus/Bitplus-Qt.conf and all else left as default,
    // bitplus-qt should set both -listen and -listenonion to false and start successfully.
