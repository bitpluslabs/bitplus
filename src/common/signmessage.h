...
#ifndef BITPLUS_COMMON_SIGNMESSAGE_H
#define BITPLUS_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bitplus address, it must refer to a public key.
...
#endif // BITPLUS_COMMON_SIGNMESSAGE_H
