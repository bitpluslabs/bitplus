...
class DecodeScriptTest(BitplusTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('btprt1pfeesu8e3df', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        # Sourced from https://github.com/bitplus/bitplus/pull/27037#issuecomment-1416151907.
        ...
        assert_equal(res["segwit"]["desc"], "addr(btprt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsuu2kak)#u4ny5qz4")
