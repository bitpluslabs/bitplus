...
#ifndef BITPLUS_QT_OPTIONSMODEL_H
#define BITPLUS_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Bitplus client.
...
public:
    ...
    BitplusUnit getDisplayUnit() const { return m_display_bitplus_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSBTPontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    BitplusUnit m_display_bitplus_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BitplusUnit unit);
...
#endif // BITPLUS_QT_OPTIONSMODEL_H
