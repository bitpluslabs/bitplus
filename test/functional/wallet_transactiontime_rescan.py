...
class TransactionTimeRescanTest(BitplusTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BTP and create transactions
        ...
        # generate some btp to create transactions and check blockcount
        ...
        # send 10 btp to user's first watch-only address
        self.log.info('Send 10 btp to user')
        ...
        # send 5 btp to our second watch-only address
        self.log.info('Send 5 btp to user')
        ...
        # send 1 btp to our third watch-only address
        self.log.info('Send 1 btp to user')
