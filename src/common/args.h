...
#ifndef BITPLUS_COMMON_ARGS_H
#define BITPLUS_COMMON_ARGS_H
...
extern const char * const BITPLUS_CONF_FILENAME;
extern const char * const BITPLUS_SETTINGS_FILENAME;
