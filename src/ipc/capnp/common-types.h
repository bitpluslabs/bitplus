...
#ifndef BITPLUS_IPC_CAPNP_COMMON_TYPES_H
#define BITPLUS_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between bitplus processes.
...
//! Functions to serialize / deserialize common bitplus types.
namespace mp {
...
#endif // BITPLUS_IPC_CAPNP_COMMON_TYPES_H
