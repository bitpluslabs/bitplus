Bitplus Core version 0.13.2 is now available from:

  <https://bitplus.org/bin/bitplus-core-0.13.2/>
...
- #8908 `4a974b2` Update bitplus-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitplus-tx to create v2 transactions (btpdrak)
