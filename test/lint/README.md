...
maintained:
* for `src/crc32c`: https://github.com/bitplus-core/crc32c-subtree.git (branch bitplus-fork)
* for `src/crypto/ctaes`: https://github.com/bitplus-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/bitplus-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/bitplus-core/leveldb-subtree.git (branch bitplus-fork)
* for `src/minisketch`: https://github.com/bitplus-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/bitplus-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/bitplus-core/secp256k1.git
```
