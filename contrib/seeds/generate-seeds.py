...
def main():
    ...
    g.write('#ifndef BITPLUS_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITPLUS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitplus network\n')
    ...
    g.write('#endif // BITPLUS_CHAINPARAMSSEEDS_H\n')
