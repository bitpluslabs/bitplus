...
#ifndef BITPLUS_NODE_CONNECTION_TYPES_H
#define BITPLUS_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitplus-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bitplus’s Peer-to-Peer Network")
...
#endif // BITPLUS_NODE_CONNECTION_TYPES_H
