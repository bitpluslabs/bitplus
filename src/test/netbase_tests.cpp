...
{
    BOOST_CHECK(TestSplitHost("www.bitpluscore.org", "www.bitpluscore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitpluscore.org]", "www.bitpluscore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitpluscore.org:80", "www.bitpluscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitpluscore.org]:80", "www.bitpluscore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bitpluscore.org:65536", "www.bitpluscore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitpluscore.org:0", "www.bitpluscore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitpluscore.org:", "www.bitpluscore.org:", 0, false));
}
