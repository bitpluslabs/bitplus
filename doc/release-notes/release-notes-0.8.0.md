Bitplus-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitplus/files/Bitplus/bitplus-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitplus
...
New/changed settings (command-line or bitplus.conf file)
--------------------------------------------------------
