...
//! Entry point for BitplusApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitplusApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitplusGUI tests.
void AppTests::guiTests(BitplusGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitplusGUI::consoleShown, this, &AppTests::consoleTests);
