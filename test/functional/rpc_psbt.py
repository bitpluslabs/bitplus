...
class PSBTTest(BitplusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 BTP/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
