Bitplus Core version *0.15.2* is now available from:

  <https://bitpluscore.org/bin/bitplus-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitplus-tx (TheBlueMatt)
