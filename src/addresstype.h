...
#ifndef BITPLUS_ADDRESSTYPE_H
#define BITPLUS_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitplus address
 */
...
/**
 * Generate a Bitplus scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // BITPLUS_ADDRESSTYPE_H
